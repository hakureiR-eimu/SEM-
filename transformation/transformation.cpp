...
GLuint texture;
//地球,月球和太阳的纹理图像
const char* earth_texture = "earth.jpg";
const char* moon_texture = "moon.jpg";
const char* sun_texture = "sun.jpg";
...
void Draw(void)
{
	...
	vmath::mat4 trans3 = vmath::perspective(60, aspact, 1.0f, 500.0f) *vmath::translate(0.0f, 0.0f, -5.0f)* vmath::rotate(xRot, vmath::vec3(0.0, 1.0, 0.0))*vmath::translate(3.0f, 0.0f, 0.0f)*vmath::scale(0.3f)*vmath::rotate(yRot, vmath::vec3(0.0, 0.0, 1.0))*vmath::translate(3.0f, 0.0f, 0.0f)*vmath::scale(0.3f);
